...
l = Question('Как меня зовут?','Вовка','Сашка', 'Пашка', 'Братик')
i = Question("Моя фамилия?", "Луконин", 'Лушников', 'Тен', 'Да')
k = Question("Моё отчество?", 'Кириллович', 'Иванович', 'Жукович', 'Лимитович')
